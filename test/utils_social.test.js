...
describe('utils.social', () => {
    ...
    describe('emailsFromUrls()', () => {
        ...
        test('extracts emails correctly', () => {
            ...
            expect(
                social.emailsFromUrls([1, 2, {}, 'fwef', null, undefined]),
            ).toEqual([]);

            expect(social.emailsFromUrls(['mailto:info@example.com'])).toEqual([
                'info@example.com',
            ]);
    ...
    describe('phonesFromUrls()', () => {
        ...
        test('extracts phones correctly', () => {
            ...
            expect(
                social.phonesFromUrls([1, 2, {}, 'fwef', null, undefined]),
            ).toEqual([]);
    ...
    describe('parseHandlesFromHtml()', () => {
        ...
        test('handles invalid arg', () => {
            ...
            expect(social.parseHandlesFromHtml(undefined)).toEqual(
                EMPTY_RESULT,
            );
        ...
        test('works', () => {
            expect(social.parseHandlesFromHtml('')).toEqual(EMPTY_RESULT);
            expect(social.parseHandlesFromHtml('         ')).toEqual(
                EMPTY_RESULT,
            );
    ...
    describe('EMAIL_REGEX', () => {
        test('works', () => {
            ...
            expect(social.EMAIL_REGEX.test('bob+something@example.co.uk')).toBe(
                true,
            );
            expect(
                social.EMAIL_REGEX.test(
                    'really.long.email.address@really.long.domain.name.travel',
                ),
            ).toBe(true);
            expect(
                social.EMAIL_REGEX.test(
            ...
            expect(
                social.EMAIL_REGEX.test(
                    'really_long_email_address@really.long.domain.name.travel',
                ),
            ).toBe(true);

            expect(social.EMAIL_REGEX.test('a alice@example.com')).toBe(false);
            expect(
                social.EMAIL_REGEX.test('bob@example.com alice@example.com'),
            ).toBe(false);
            expect(social.EMAIL_REGEX.test('')).toBe(false);
            expect(social.EMAIL_REGEX.test('dummy')).toBe(false);

            expect(social.EMAIL_REGEX_GLOBAL.test('bob@example.com')).toBe(
                true,
            );
            expect(
                'bob@example.com alice@example.com'.match(
    ...
    describe('LINKEDIN_REGEX', () => {
        test('works', () => {
            ...
            expect(
                social.LINKEDIN_REGEX.test(
                    'http://www.linkedin.com/in/bobnewman',
                ),
            ).toBe(true);
            expect(
                social.LINKEDIN_REGEX.test(
                    'http://ie.linkedin.com/in/bobnewman',
                ),
            ).toBe(true);
            expect(
                social.LINKEDIN_REGEX.test('https://linkedin.com/in/bobnewman'),
            ).toBe(true);
            expect(
                social.LINKEDIN_REGEX.test(
                    'https://www.linkedin.com/in/carl-newman',
            ...
            expect(
                social.LINKEDIN_REGEX.test(
                    'https://www.linkedin.com/in/first_last_1%23456a',
                ),
            ).toBe(true);
            expect(
                social.LINKEDIN_REGEX.test(
            ...
            expect(
                social.LINKEDIN_REGEX.test('www.linkedin.com/in/bobnewman'),
            ).toBe(true);
            expect(
                social.LINKEDIN_REGEX.test('linkedin.com/in/bobnewman'),
            ).toBe(true);
            ...
            expect(
                social.LINKEDIN_REGEX.test('en.linkedin.com/in/alan-turing'),
            ).toBe(true);
            expect(
                social.LINKEDIN_REGEX.test('linkedin.com/in/alan-turing'),
            ).toBe(true);

            // Test there is just on matching group for the username
            expect(
                'https://www.linkedin.com/in/bobnewman/'.match(
                    social.LINKEDIN_REGEX,
                )[1],
            ).toBe('bobnewman');
            expect(
                'http://www.linkedin.com/in/bobnewman'.match(
                    social.LINKEDIN_REGEX,
                )[1],
            ).toBe('bobnewman');
            expect(
                'www.linkedin.com/in/bobnewman/'.match(
                    social.LINKEDIN_REGEX,
                )[1],
            ).toBe('bobnewman');
            expect(
                'linkedin.com/in/bobnewman'.match(social.LINKEDIN_REGEX)[1],
            ).toBe('bobnewman');
            ...
            expect(
                social.LINKEDIN_REGEX.test(
                    'a https://www.linkedin.com/in/bobnewman',
                ),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test(
                    'https://linkedin.com/in/bobnewman/sub-page',
                ),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test(
                    'xhttps://www.linkedin.com/in/carl-newman',
                ),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test(
                    '0https://www.linkedin.com/in/carl-newman',
                ),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test(
                    '_https://www.linkedin.com/in/carl-newman',
                ),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test('xlinkedin.com/in/bobnewman'),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test('_linkedin.com/in/bobnewman'),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test('0linkedin.com/in/bobnewman'),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test(
                    'https://www.linkedin.com/in/bobnewman/?param=bla',
                ),
            ).toBe(false);
            expect(
                social.LINKEDIN_REGEX.test('://linkedin.com/in/bobnewman'),
            ...
            expect(
                social.LINKEDIN_REGEX.test(
                    'https://www.linkedin.com/in/bob https://www.linkedin.com/in/alice',
                ),
            ).toBe(false);

            expect(
                social.LINKEDIN_REGEX_GLOBAL.test(
                    'https://www.linkedin.com/in/bobnewman',
                ),
            ).toBe(true);
            expect(
    ...
    describe('INSTAGRAM_REGEX', () => {
        test('works', () => {
            ...
            expect(
                social.INSTAGRAM_REGEX.test(
                    'http://www.instagram.com/old_prague/',
                ),
            ).toBe(true);
            expect(
                social.INSTAGRAM_REGEX.test(
                    'https://instagram.com/old_prague/',
                ),
            ).toBe(true);
            expect(
                social.INSTAGRAM_REGEX.test('HTTPS://INSTAGR.AM/OLD_PRAGUE/'),
            ).toBe(true);
            expect(
                social.INSTAGRAM_REGEX.test('http://instagr.am/old_prague/'),
            ).toBe(true);
            expect(
                social.INSTAGRAM_REGEX.test(
                    'https://www.instagr.am/old_prague/',
                ),
            ).toBe(true);
            expect(
                social.INSTAGRAM_REGEX.test('www.instagram.com/old_prague/'),
            ).toBe(true);
            expect(
                social.INSTAGRAM_REGEX.test('instagram.com/old_prague/'),
            ).toBe(true);
            expect(
                social.INSTAGRAM_REGEX.test('www.instagr.am/old_prague/'),
            ).toBe(true);
            expect(social.INSTAGRAM_REGEX.test('instagr.am/old_prague/')).toBe(
                true,
            );

            // Test there is just on matching group for the username
            expect(
                'https://www.instagram.com/old_prague/'.match(
                    social.INSTAGRAM_REGEX,
                )[1],
            ).toBe('old_prague');
            expect(
                'http://www.instagram.com/old_prague/'.match(
                    social.INSTAGRAM_REGEX,
                )[1],
            ).toBe('old_prague');
            expect(
                'www.instagram.com/old_prague'.match(social.INSTAGRAM_REGEX)[1],
            ).toBe('old_prague');
            expect(
                'instagram.com/old_prague'.match(social.INSTAGRAM_REGEX)[1],
            ).toBe('old_prague');
            ...
            expect(
                social.INSTAGRAM_REGEX.test(
                    'a https://www.instagram.com/old_prague',
                ),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test('https://www.instagram.com/a'),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test(
                    'https://www.instagram.com/old_prague/sub-page',
                ),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test(
                    'xhttps://www.instagram.com/old_prague',
                ),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test(
                    '0https://www.instagram.com/old_prague',
                ),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test(
                    '_https://www.instagram.com/old_prague',
                ),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test('xinstagram.com/old_prague'),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test('_instagram.com/old_prague'),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test('0instagram.com/old_prague'),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test(
                    'https://www.instagram.com/old_prague/?param=bla',
                ),
            ).toBe(false);
            expect(
                social.INSTAGRAM_REGEX.test('://www.instagram.com/old_prague'),
            ...
            expect(
                social.INSTAGRAM_REGEX.test(
                    'http://www.instagram.com/old_prague http://www.instagram.com/old_brno',
                ),
            ).toBe(false);

            expect(
                social.INSTAGRAM_REGEX_GLOBAL.test(
                    'https://www.instagram.com/old_prague',
                ),
            ).toBe(true);
            expect(
    ...
    describe('TWITTER_REGEX', () => {
        test('works', () => {
            ...
            expect(
                social.TWITTER_REGEX.test('https://www.twitter.com/apify'),
            ).toBe(true);
            expect(
                social.TWITTER_REGEX.test('https://www.twitter.com/apify/'),
            ).toBe(true);
            expect(
                social.TWITTER_REGEX.test('https://www.twitter.com/aa_bb_123'),
            ).toBe(true);
            expect(
                social.TWITTER_REGEX.test('http://www.twitter.com/apify'),
            ).toBe(true);
            expect(social.TWITTER_REGEX.test('https://twitter.com/apify')).toBe(
                true,
            );
            expect(social.TWITTER_REGEX.test('http://twitter.com/apify')).toBe(
                true,
            );
            expect(social.TWITTER_REGEX.test('www.twitter.com/apify')).toBe(
                true,
            );
            ...
            // Test there is just on matching group for the username
            expect(
                'https://www.twitter.com/apify/'.match(social.TWITTER_REGEX)[1],
            ).toBe('apify');
            expect(
                'http://www.twitter.com/apify'.match(social.TWITTER_REGEX)[1],
            ).toBe('apify');
            expect('www.twitter.com/apify'.match(social.TWITTER_REGEX)[1]).toBe(
                'apify',
            );
            expect('twitter.com/apify'.match(social.TWITTER_REGEX)[1]).toBe(
                'apify',
            );
            ...
            expect(
                social.TWITTER_REGEX.test('a https://www.twitter.com/apify'),
            ).toBe(false);
            expect(
                social.TWITTER_REGEX.test(
                    'https://www.twitter.com/apify/sub-page',
                ),
            ).toBe(false);
            expect(
                social.TWITTER_REGEX.test('xhttps://www.twitter.com/apify'),
            ).toBe(false);
            expect(
                social.TWITTER_REGEX.test('0https://www.twitter.com/apify'),
            ).toBe(false);
            expect(
                social.TWITTER_REGEX.test('_https://www.twitter.com/apify'),
            ).toBe(false);
            ...
            expect(
                social.TWITTER_REGEX.test(
                    'https://www.twitter.com/apify?param=bla',
                ),
            ).toBe(false);
            expect(social.TWITTER_REGEX.test('://www.twitter.com/apify')).toBe(
                false,
            ...
            expect(
                social.TWITTER_REGEX.test(
                    'https://www.twitter.com/apify https://www.twitter.com/jack',
                ),
            ).toBe(false);
            expect(
                social.TWITTER_REGEX.test('https://www.twitter.com/oauth'),
            ).toBe(false);
            expect(
                social.TWITTER_REGEX.test('https://www.twitter.com/account'),
            ).toBe(false);
            expect(
                social.TWITTER_REGEX.test('https://www.twitter.com/privacy/'),
            ).toBe(false);

            expect(
                social.TWITTER_REGEX_GLOBAL.test(
                    'https://www.twitter.com/apify',
                ),
            ).toBe(true);
            expect(
    ...
    describe('FACEBOOK_REGEX', () => {
        test('works', () => {
            ...
            expect(
                social.FACEBOOK_REGEX.test(
                    'http://www.facebook.com/some.username123',
                ),
            ).toBe(true);
            expect(
                social.FACEBOOK_REGEX.test('www.facebook.com/someusername'),
            ).toBe(true);
            expect(
                social.FACEBOOK_REGEX.test('facebook.com/someusername'),
            ).toBe(true);
            expect(
                social.FACEBOOK_REGEX.test('https://www.fb.com/someusername'),
            ).toBe(true);
            expect(
                social.FACEBOOK_REGEX.test('https://www.fb.com/someusername/'),
            ).toBe(true);
            expect(
                social.FACEBOOK_REGEX.test(
                    'http://www.fb.com/some.username123',
                ),
            ).toBe(true);
            expect(social.FACEBOOK_REGEX.test('www.fb.com/someusername')).toBe(
                true,
            );
            expect(social.FACEBOOK_REGEX.test('fb.com/someusername')).toBe(
                true,
            );
            ...
            expect(
                social.FACEBOOK_REGEX.test(
                    'http://www.facebook.com/profile.php?id=1155802082',
                ),
            ).toBe(true);
            expect(
                social.FACEBOOK_REGEX.test(
                    'www.facebook.com/profile.php?id=1155802082',
                ),
            ).toBe(true);
            expect(
                social.FACEBOOK_REGEX.test(
                    'facebook.com/profile.php?id=1155802082',
                ),
            ).toBe(true);
            expect(
                social.FACEBOOK_REGEX.test('fb.com/profile.php?id=1155802082'),
            ).toBe(true);

            // Test there is just on matching group for the username
            expect(
                'https://www.facebook.com/someusername/'.match(
            ...
            expect(
                'https://www.facebook.com/profile.php?id=1155802082'.match(
                    social.FACEBOOK_REGEX,
                )[1],
            ).toBe('profile.php?id=1155802082');
            expect('fb.com/someusername'.match(social.FACEBOOK_REGEX)[1]).toBe(
                'someusername',
            );
            ...
            expect(
                social.FACEBOOK_REGEX.test(
                    'a https://www.facebook.com/someusername',
                ),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test('https://www.facebook.com/a'),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test(
                    'https://www.facebook.com/someusername/sub-page',
                ),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test(
            ...
            expect(
                social.FACEBOOK_REGEX.test(
                    'xhttps://www.facebook.com/someusername',
                ),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test(
                    '0https://www.facebook.com/someusername',
                ),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test(
                    '_https://www.facebook.com/someusername',
                ),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test('xfacebook.com/someusername'),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test('_facebook.com/someusername'),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test('0facebook.com/someusername'),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test(
                    'https://www.facebook.com/someusername?param=bla',
                ),
            ).toBe(false);
            ...
            expect(
                social.FACEBOOK_REGEX.test(
                    'https://www.facebook.com/someusername https://www.facebook.com/jack',
                ),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test('https://www.facebook.com/groups'),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test('https://www.facebook.com/events'),
            ).toBe(false);
            expect(
                social.FACEBOOK_REGEX.test(
            ...
            expect(
                social.FACEBOOK_REGEX_GLOBAL.test(
                    'https://www.facebook.com/someusername',
                ),
            ).toBe(true);
            expect(
    ...
    describe('YOUTUBE_REGEX', () => {
        it('works', () => {
            ...
            expect(
                social.YOUTUBE_REGEX.test(
                    'https://www.youtube.com/watch?v=kM7YfhfkiEE',
                ),
            ).toBe(true);
            expect(
                social.YOUTUBE_REGEX.test('https://youtu.be/kM7YfhfkiEE'),
            ).toBe(true);
            expect(
                `
            ...
            ).toEqual(['https://www.youtube.com/watch?v=kM7YfhfkiEE']);
        });
    });
});
